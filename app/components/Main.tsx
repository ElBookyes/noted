  ...
  return (
    <>
      <header>
        ...
        <div className="categories" aria-label="categories menu">
          <button
            onClick={() => {
              setFavToggle(false);
            ...
            className={`${
              myNotesToggle ? "current-category kpds-fw-bold" : ""
            } my-notes | kpds-clr-current-white kpds-fw-semi-bold kpds-fs-600 clean kpds-pointer`}
          >
            Home
          </button>
          <button
            ...
            className={`${
              favToggle ? "current-category kpds-fw-bold" : ""
            } favorite-notes | kpds-clr-current-white kpds-fw-semi-bold kpds-fs-600 clean kpds-pointer`}
          >
            Favorites
          </button>
          <button
            ...
            className={`${
              publicToggle ? "current-category kpds-fw-bold" : ""
            } public-notes | kpds-clr-current-white kpds-fw-semi-bold kpds-fs-600 clean kpds-pointer`}
          >
            Public
          </button>
        </div>
